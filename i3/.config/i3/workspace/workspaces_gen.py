...
class Workspaces(object):
    ...
    def get_win_label(self, window):
        ...
        multi_subs = [
            ...
            [["Thunar"], "\uf115 "],  # fa-folder-open-o
            [["Nautilus", "nautilus"], "\uf115 "] # fa-folder-open-o
            [["Eog", "feh"], "\uf03e"],  # fa-picture
            [["Evince", "zathura"], "\uf1c1"],  # fa-file-pdf-o
            [["Quodlibet", "Rhythmbox"], "♪"],
            [["X-terminal-emulator", "Terminator", "Xfce4-terminal"], "'\uf120"], 
        ]
